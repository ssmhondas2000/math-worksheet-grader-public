...
def grade_and_overlay(image_pil):
    ...
    data = pytesseract.image_to_data(image_cv, config='--psm 4', output_type=pytesseract.Output.DICT)
...
print("Hello, my name is %s and I am %d years old." % (convert_to_downloadable, convert_to_downloadable))
